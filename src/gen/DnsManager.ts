...
// Introspection XML of org.freedesktop.NetworkManager at /org/freedesktop/NetworkManager/DnsManager
 ...
 * ObjectPath: /org/freedesktop/NetworkManager/DnsManager
 * Interface: org.freedesktop.NetworkManager.DnsManager
 */
export class DnsManager extends EventEmitter {

    public readonly dbusInterfaceName = 'org.freedesktop.NetworkManager.DnsManager';
    ...
    public static Connect(bus: DBus.MessageBus, objectPath: string = "/org/freedesktop/NetworkManager/DnsManager", xml: string = XMLObjectData): Promise<DnsManager> {
        return bus.getProxyObject('org.freedesktop.NetworkManager', objectPath, xml).then((obj) => new DnsManager(obj));
    }

    constructor(dbusObject: DBus.ProxyObject) {
        super();
        this.dbusObject = dbusObject;
        this.thisDBusInterface = this.dbusObject.getInterface('org.freedesktop.NetworkManager.DnsManager');
    ...
    //@property({ name: 'Mode', signature: 's', access: ACCESS_READ })
    public Mode(): Promise<string> {
        return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'Mode').then((variant: DBus.Variant) => variant.value);
    }

    //@property({ name: 'RcManager', signature: 's', access: ACCESS_READ })
    public RcManager(): Promise<string> {
        return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'RcManager').then((variant: DBus.Variant) => variant.value);
    }

    //@property({ name: 'Configuration', signature: 'aa{sv}', access: ACCESS_READ })
    public Configuration(): Promise<Array<{[key: string]: DBus.Variant}>> {
        return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'Configuration').then((variant: DBus.Variant) => variant.value);
    }
