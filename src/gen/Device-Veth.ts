...
// Introspection XML of org.freedesktop.NetworkManager at /org/freedesktop/NetworkManager/Devices/49
...
<node>
  ...
  <interface name="org.freedesktop.NetworkManager.Device.Veth">
    ...
    <property type="o" name="Peer" access="read"/>
  </interface>
 ...
 * ObjectPath: /org/freedesktop/NetworkManager/Devices/49
 * Interface: org.freedesktop.NetworkManager.Device.Veth
 */
export class DeviceVeth extends EventEmitter {

    public readonly dbusInterfaceName = 'org.freedesktop.NetworkManager.Device.Veth';
    ...
    public static Connect(bus: DBus.MessageBus, objectPath: string = "/org/freedesktop/NetworkManager/Devices/49", xml: string = XMLObjectData): Promise<DeviceVeth> {
        return bus.getProxyObject('org.freedesktop.NetworkManager', objectPath, xml).then((obj) => new DeviceVeth(obj));
    }

    constructor(dbusObject: DBus.ProxyObject) {
        super();
        this.dbusObject = dbusObject;
        this.thisDBusInterface = this.dbusObject.getInterface('org.freedesktop.NetworkManager.Device.Veth');
    ...
    //@property({ name: 'Peer', signature: 'o', access: ACCESS_READ })
    public Peer(): Promise<DBus.ObjectPath> {
        return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'Peer').then((variant: DBus.Variant) => variant.value);
    }
...
/***** Signals for org.freedesktop.NetworkManager.Device.Veth *****/
export declare interface DeviceVeth {
